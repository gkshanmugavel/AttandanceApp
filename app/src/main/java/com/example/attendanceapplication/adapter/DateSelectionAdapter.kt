package com.example.attendanceapplication.adapter
...
import com.example.attendanceapplication.databinding.RowCalendarDateBinding
...
class DateSelectionAdapter(private val onDateSelection: (DateDetailsUI) -> Unit) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DateViewHolder {
        val view = RowCalendarDateBinding.inflate(LayoutInflater.from(parent.context))
        return DateViewHolder(view)
    }


    inner class DateViewHolder(private val binding: RowCalendarDateBinding) :
